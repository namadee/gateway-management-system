...
const GatewayList = () => {
  ...
  //edit gateway function
  const editGateway = async (gatewayId, updatedGateway) => {
    ...
    console.log('Gateway updated successfully:', gatewayId, updatedGateway);
   
  };

  //Handle edit button
  const handleEditButtonClick = (gateway) => {
  ...
  <Popup trigger={popupForm} setTrigger={setPopupForm}>
    <AddGatewayForm
      ...
      handleGatewayEdit={editGateway}
      gatewayData={editGatewayData}
    />
  </Popup>
)}
        ...
        {gateways.map((gateway) => (
            <StyledTableRow key={gateway._id}>
              ...
              <StyledTableCell align="center">
                <EditIcon onClick = {() => handleEditButtonClick(gateway)} />
              </StyledTableCell>
              <StyledTableCell align="center">
